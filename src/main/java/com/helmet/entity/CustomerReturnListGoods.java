...
public class CustomerReturnListGoods {
	...
	@Id
	@GeneratedValue
	private Integer customerReturnListGoodsId;    //编号
	
	@ManyToOne
	@JoinColumn(name="customerReturnListId")
	private CustomerReturnList customerReturnList;    //销售单
	...
	public String toString() {
		return "CustomerReturnListGoods [customerReturnListGoodsId=" + customerReturnListGoodsId + ", customerReturnList=" + customerReturnList + ", code="
